            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-6">
                        <div class="white-box text-center shadow p-3 mb-5 bg-white rounded"><img height="430"
                                width="430" src="img/<?php echo $idpro ?>.png" class="img-responsive"></div>
                    </div>
