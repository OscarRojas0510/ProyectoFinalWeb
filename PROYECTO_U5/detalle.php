...
<br>
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6">
                    <div class="white-box text-center shadow p-3 mb-5 bg-white rounded"><img height="350" width="350" src="/Proyecto_U5/resources/img/<?php echo $imagen ?>" class="img-responsive"></div>
                </div>
