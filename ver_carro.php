                                ...
                                <div id="collapseCC" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body" align-items-center>
                                        <div class="mb-3">
                                            ...
                                            <input id="tarjeta" type="number" maxlength="16" minlength="16"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="cvv" type="password" class="form-control"
                                                        autocomplete="off" maxlength="3" minlength="3">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="p-3 bg-light bg-opacity-10">
                                                ...
                                                <button id="pagar" class="btn btn-black w-100 mt-2" 
                                                    style="background-color: pink" ;><strong>Realizar pago</strong>
                    ...
                    if ($("#nombre").val() <= 1) {
                        ...
                        if ($("#mes").val() > 5 && $("#mes") < 12) {
                            ...
                            if ($("#anio").val() < 23) {
                                ...
                                alert('¡Usuario registrado correctamente! ¡Bienvenid!');
